...
public class FunctionFirstGroup {
    ...
    @FunctionName("FunctionFirstGroup")
    public void run(
           //@TimerTrigger(name = "timerInfo", schedule = "0 0 0 LW * ? *") String timerInfo,
            @TimerTrigger(name = "timerInfo", schedule = "0 */5 * * * *") String timerInfo,
            @SQLInput(
                    name = "itemsFirstGroup",
                    commandText = Querys.LIST_WELCOME_FIRST_GROUP,
                    commandType = "Text",
